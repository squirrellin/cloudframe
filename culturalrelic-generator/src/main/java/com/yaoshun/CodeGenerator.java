...
public class CodeGenerator {
     ...
     * 项目名称
     */
    static String projectName = "/culturalrelic-web-rest/";

    /**
     * 项目路径
     */
    static String basePath = projectName + "src/main/java/com/yaoshun/";
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/black?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        */
        ...
        strategy.setSuperEntityClass("com.yaoshun.base.BaseModel");
